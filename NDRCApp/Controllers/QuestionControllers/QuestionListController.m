...
- (void)viewDidLoad {
    ...
    [self initMainTitleBar:self.titleStr];
    self.menubtn.hidden=YES;
    self.tempArray=[NSMutableArray array];
    self.myView=[[QuestionListView alloc] initWithFrame:CGRectMake(0, appNavigationBarHeight, k_ScreenWidth, k_ScreenHeight-appNavigationBarHeight)];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (cell==nil) {
        ...
        cell.qyNameLabel.text=@"沈阳经济技术开发区";
        cell.qyContactLabel.text=@"沈阳经";
        cell.timeLabel.text=@"2017.02.03 15:65";
