...
@implementation statisticesSecondView
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.colorArray=[NSMutableArray arrayWithObjects:ColorWithAlpha(0xfc7c3f, 1),ColorWithAlpha(0x17b56e, 1),ColorWithAlpha(0x4dc5f9, 1), nil];
        self.titleArray=[NSMutableArray arrayWithObjects:@"超时响应",@"按时响应",@"未响应", nil];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.delegate) {
        [self.delegate SecondViewOnSelectCellWithTitle:self.titleArray[indexPath.row]];
    }
}
